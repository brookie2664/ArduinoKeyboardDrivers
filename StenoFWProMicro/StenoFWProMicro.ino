 ...
 * 
 * To do:
 * Define new Fn2 function for toggling Plover.
 * To do this: When Fn2 is pressed alone, input a string.
...
char keys[ROWS][COLS] = {
  ...
  New Matrix: (Top asterisks for left hand, bottom asterisks for right)
  {'S', 'T', 'P', 'H', '*', Fn1},
  {'S', 'K', 'W', 'R', '*', Fn2},
  {'a', 'o', 'e', 'u', '#'},
  {'f', 'p', 'l', 't', 'd', '*'},
...
int rowPins[ROWS] = {15, 14, 16, 10, 9};
int colPins[COLS] = {8, 7, 6, 5, 4, 3};
int ledPin = 2;
...
// Added functions: Toggle Plover. (to do)
void fn2() {
